...
- **densidad real:**  el peso por unidad de volumen de la porción sólida de suelo (sin incluir poros). La densidad aumenta con un mayor contenido de metales pesados (ej., magnetita, limonita y hematita).
